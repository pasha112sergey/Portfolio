      ...
      <div className="flex flex-wrap">
          ...
          <div className="flex items-center justify-center">
            <ThreeDCard rotateDivisor={150} hoverScale={1.05}>
              <a href="https://www.instagram.com/sbuskate/">
                <img className="rounded-3xl" src={clubimg} alt="about"></img>
              </a>
            </ThreeDCard>
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col justify-center lg:justify-start space-y-4">
            ...
            <h1 className="text-center font-bold mb-2">{CLUB.hook}</h1>
            <div className="flex flex-col lg:flex-row justify-center items-center">
              ...
              >
                <ThreeDCard rotateDivisor={150} hoverScale={1.05}>
                  <InstagramEmbed
                    url={CLUB.urls[1]}
                    className="max-w-[400px] scale-75 mx-auto rounded-3xl"
                  />
                </ThreeDCard>
              </motion.div>
            </div>
